...
import ingredientsIcon from "../assets/icons/IconIngrédient.png" 
...
function NavigateBar() {
    ...
    return (
        <div>
        <Link to = "/recipes" className={recipesActive ? "ButtonRecipes active" : "ButtonRecipes"}>
        <img src={recipesIcon} alt="" />
        <span>Recettes</span>
        </Link>
        <Link to = "/inventory"className={inventoryActive ? "ButtonInventory active" : "ButtonInventory"}>
        <img src={inventoryIcon} alt="Inventaire" />
        <span>Inventaire</span>
        </Link>
        <Link to = "/ingredients"className={ingredientActive ? "ButtonIngredients active" : "ButtonIngredients"}>
